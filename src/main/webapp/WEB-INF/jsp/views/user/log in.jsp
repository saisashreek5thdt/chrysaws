...
<center>
	<br><br>	<br><br>	<br><br>
	 ...
	 <div class="col-md-9" style="background: white;height:18%;border-radius: 10px;" >
        <input type="email" id="inp" name="email"   placeholder="Email Id*" required>

        ${error}
    </div>
    <br>
    <div class="col-md-9" style="background: white;height:18%;border-radius: 10px;" >
        <input type="password" id="inp" name="password" placeholder="password*" required >
    </div><br>
