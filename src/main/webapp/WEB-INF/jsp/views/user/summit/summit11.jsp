...
<div class="col-md-12"  id="summitbg" style="background-image:url('../assets/uploads/slider/${row.slider}')">
    ...
    <div style="top:180px;left:20%;width:35% ;height:30%;background: transparent;position: absolute;z-index:1">

        <img class="d-block w-100" src="../assets/user/images/Group 506.png"      >
    </div> </c:if >
                                        </c:forEach>
</div>
</div>
 ...
 <center>
     <div class="col-md-11" id="boxin">
         <div class="boxcir">
           ...
           <img src="../assets/user/images/2747682.png" style="height:70%;width:85%">
           <p style="width:50%;font-size:14px;font-family: Segoe UI semibold;text-align:center;color: #A2FF00;position: relative;top:-4%">  
            <br><a href="#" style="color: #A2FF00;">    Title Topic
                Name of the Person</a>
            </p>
                ...
                <div class="row" >
                    ...
                    <center>
                     ...
                     <div class="col-md-11" id="boxin">
                          ...
                          <img src="../assets/user/images/2747682.png" style="height:70%;width:85%;position: relative;top:4%">
                               <p style="width:50%;font-size:14px;font-family: Segoe UI semibold;text-align:center;color: #00FFF6;position: relative;top:2%">  
                               <br>
