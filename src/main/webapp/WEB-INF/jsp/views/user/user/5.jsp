...
<c:forEach items="${rcList}" var="rowk">
    ...
    <c:forEach items="${rcList}" var="rowk">
          <c:if test="${rowk.coursename==row.coursename}">
          <c:set var="co1uns" value="${co1uns + 1}" scope="page"/>
           <c:if test="${co1uns<'2'}">
           <c:forEach items="${resourceList}" var="rowm">

               <c:if test="${rowm.resource_name==rs && rowm.category=='Worksheets' }">
    			<c:set var="co1un1s" value="${co1un1s + 1}" scope="page"/>
    			<c:if test="${co1un1s<'5'}">
    					<div class="col-md-2">
    						<div class="col-md-10" id="videoout"  >

           <c:if test="${rowm.resource_name==rs && rowm.filetype=='ppt' }">
<a href="../assets/uploads/ppt/${rowm.filename}" style="color:#0A62A3;font-size:12px" target="_blank">
	<img src="../assets/user/images/ppt.png" style="height: 70%;">
	 ...
	 <c:if test="${rowm.resource_name==rs && rowm.filetype=='word' }">
    ...
    <c:if test="${rowm.resource_name==rs && rowm.filetype=='pdf' }">
   <a href="../assets/uploads/pdf/${rowm.filename}" style="color:#0A62A3;font-size:12px" target="_blank">
    ...
    <c:forEach items="${rcList}" var="rowk">
          <c:if test="${rowk.coursename==row.coursename}">
          <c:set var="co1unsq" value="${co1unsq + 1}" scope="page"/>
           <c:if test="${co1unsq<'2'}">
           <c:forEach items="${resourceList}" var="rowm">

               <c:if test="${rowm.resource_name==rs && rowm.category=='Activity ' }">
    			<c:set var="co1un1sq" value="${co1un1sq + 1}" scope="page"/>
    			<c:if test="${co1un1sq<'5'}">
    					<div class="col-md-2">
    						<div class="col-md-10" id="videoout"  >
...
<a href="../assets/uploads/ppt/${rowm.filename}" style="color:#0A62A3;font-size:12px" target="_blank">
   ...
   <a href="../assets/uploads/pdf/${rowm.filename}" style="color:#0A62A3;font-size:12px" target="_blank">
    ...
    <c:forEach items="${rcList}" var="rowk">
          <c:if test="${rowk.coursename==row.coursename}">
          <c:set var="co1unsq1" value="${co1unsq1 + 1}" scope="page"/>
           <c:if test="${co1unsq1<'2'}">
           <c:forEach items="${resourceList}" var="rowm">

               <c:if test="${rowm.resource_name==rs && rowm.category=='Articles' }">
    			<c:set var="co1un1sq1" value="${co1un1sq1 + 1}" scope="page"/>
    			<c:if test="${co1un1sq1<'5'}">
    					<div class="col-md-2">
    						<div class="col-md-10" id="videoout"  >
