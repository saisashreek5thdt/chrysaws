...
<div class="container-fluid">   
	...
	<c:set var="countb" value="${countb + 1}" scope="page"/>
			   ...
			   <div class="col" style="width: 100%;border-radius: 10px;  outline: 1px dashed #0A62A3;
			...
			<center>
			<font style="color: #FFF700;font-size: 10px;font-family: Segoe UI semibold;">5000</font>
			</center>
			</div>
...
<font style="color:#F36978;font-size: 11px;font-family: Segoe UI semibold;">
	Course starts on 01/01/2021</font>
					...
					<c:forEach items="${rcList}" var="rowk">
						...
						<c:set var="counv" value="${counv + 1}" scope="page"/>
						 ...
						 <c:forEach items="${resourceList}" var="rowm">
							...
							<div class="col-md-12">
                        						<div class="col-md-11" style="border-top: 5px solid #0A62A3;"  >
