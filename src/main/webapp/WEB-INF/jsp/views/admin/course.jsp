   	  ...
   	  function pay(){
           ...
           if( document.getElementById("category").value=="Free"){
   		  ...
   		  if( document.getElementById("category").value=="Paid"){
   			 document.getElementById("amounts").style.display="flex";
   ...
   <body>
                                       ...
                                       <div class="card-content">
                                          ...
                                          <h2 class="mb-3 font-18">
                                                                           <c:forEach items="${courseList}" var="row">
                                                                                    ...
                                                                                    <c:set var="coun1" value="${coun1 + 1}" scope="page"/>
                                                                                           </c:if >
                                                                                                                                                                                                      </c:forEach>
                                                                                                                                                ${coun1 }
                                       ...
                                       <div class="card-content">
                                          ...
                                          <h2 class="mb-3 font-18">
                                                <c:forEach items="${courseList}" var="row">
                                                                                                                              ...
                                                                                                                              <c:set var="countq" value="${countq + 1}" scope="page"/>
                                                                                                                                     </c:if >
                                                                                                                                                                                                                                                </c:forEach>
                                                                                                                                                                                          ${countq }
         ...
         <c:forEach items="${courseList}" var="row">
          <form method="post">
                                    ...
                                    <tr>
                                       ...
                                       <td>${row.amount}</td>
                                       <td>
										 <button formaction="/viewcourse?id=${row.id}"  class="btn btn-success btn-action mr-1" data-toggle="tooltip" title="View">
				  ...
				  <div class="row">
					<div class="col-12">
					   <div class="card">
						  ...
						  <div class="card-body">
	 <form  method="post" action="/create_course" enctype="multipart/form-data">
							 ...
							 <div class="form-group row mb-4">
								...
								<div class="col-sm-12 col-md-2">
									<select required class="form-control" name="category"  id="category"  onchange="return pay()">
								...
								<div class="col-sm-4 col-md-3">
										<div class="input-group mb-3"  id="amounts" style="display:none">
										<div class="input-group-prepend">
											<span class="input-group-text">
												<i class="fas fa-rupee-sign"></i>
											</span>
										</div>
										<input type="text" required name="amount" class="form-control" value="0" aria-label="Amount (to the nearest ruppee)">
									</div>
								</div> 
							 </div>
                             			 ...
                             			 <div class="col-sm-12 col-md-7">
                             				 <div id="image-preview" class="image-preview">
                             					  <label for="image-upload" id="image-label">Choose File</label>
                             						 <input type="file" required name="file" name="image" id="image-upload" accept="image/*"  onchange="return fileValidation()"/>
                             				   </div>
                             				</div>
                              </div>
                    ...
                    <div class="form-group row mb-4">
								 ...
								 <div class="col-sm-4 col-md-4">
                                        ...
                                        <c:forEach items="${resourceList}" var="row">
                                                                  ...
                                                                  <option value="${row.resource_name}">${row.resource_name}</option>
     ...
     <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="date" required name="start">      <input type="date" name="end" required>
                      </div>
                    ...
                    <br>
							 ...
							 <div class="form-group row mb-4">
								 ...
								 <div class="col-sm-12 col-md-2">
									 <input type="text" name="skills" required  class="form-control inputt ags">
								 </div>
								 <div class="col-sm-12 col-md-2">
