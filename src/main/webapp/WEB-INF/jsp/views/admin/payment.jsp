                                 ...
                                 <table class="table table-striped">
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-truncate">
                                               <c:forEach items="${userList}" var="rowt">
                                                    <c:if test="${rowt.id==row.user}">
                                            ${rowt.email}
                                                </c:if >
                                              </c:forEach>
                                       </td>
                                       ...
                                       <td>
                                        ...
                                        <c:if test="${row.category=='course'}">
                                          <div class="badge badge-success">Course</div>

                                                           </c:if >
                                                            <c:if test="${row.category=='resource'}">
                                                                       <div class="badge badge-danger">Resource</div>
