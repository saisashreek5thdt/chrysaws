                                    ...
                                    <tr>
                                       ...
                                       <input type="hidden" value="${row.resource_name}" name="titleedit">
                                        <input type="hidden" value="${row.amount}" name="amountedit">
                                           <textarea type="hidden" style="display:none;" value="${row.about_resourse}" name="aboutedit">
                                           </textarea>
				  ...
				  <div class="row">
					<div class="col-12">
					   <div class="card">
						  ...
						  <section id="editResource">
						  	 <form  method="post" enctype="multipart/form-data">
						  <div class="card-body">
							 <div class="form-group row mb-4">
								<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Title</label>
								<div class="col-sm-12 col-md-4">
								   <input type="text" value="${param.titleedit}" readonly name="title" id="title" required class="form-control" onchange="titlecheck()">
<font color="red">
                                  ${warn}
							 ...
							 <div class="form-group row mb-4">
								...
								<div class="col-sm-4 col-md-3">
									<div class="input-group mb-3">
										...
										<input type="hidden" name="ide"  value="${param.idedit}">
										<input type="text" name="amount"  value="${param.amountedit}"  id="amount" class="form-control" aria-label="Amount (to the nearest ruppee)">
									</div>
								</div>
							 </div>
							 <div class="form-group row mb-4">
								 ...
								 <div class="col-sm-12 col-md-7">
									 <div id="image-preview" class="image-preview">
									  ...
									  <input type="file" name="image" value="${param.imageedit}" required id="image-upload" accept="image/*"  onchange="return fileValidation()"  />
									 </div>
									 <img src="assets/uploads/${param.imageedit}" style="height:200px;width:200px;">
							 ...
							 <div class="form-group row mb-4">
								...
								<p>
								   ...
								   <textarea class="summernote-simple"  maxlength="10" required name="about_resource" value="${param.aboutedit}"></textarea>
								</div>
							 </div>
							 ...
							 <div class="form-group row mb-4">
								 ...
								 <div class="col-sm-12 col-md-2">
                                  <input type="text" name="tit"  maxlength="12"  class="form-control inputtags" placeholder="Title">
                                 								 </div>
	 ...
	 <div class="col-sm-12 col-md-2">
							 ...
							 <div class="form-group row mb-4">
								<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
								<div class="col-sm-12 col-md-7">
								   <button formaction="/edit_resource" class="btn btn-primary">Edit RESOURCE</button>
								</div>
							 </div>
